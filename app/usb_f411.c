...
static usbd_device *stm32f411_usbd_init(void);

static struct _usbd_device usbd_dev;

const struct _usbd_driver stm32f411_usb_driver = {
	.init = stm32f411_usbd_init,
...
static usbd_device *stm32f411_usbd_init(void)
{
	...
	/* Enable VBUS sensing in device mode and power down the PHY. */
        ...
        /* My board doesn't have VBus connected to PA0, so we've gotta go with
           NOVBUSSENS here */
        
	OTG_FS_GCCFG |= /*OTG_FS_GCCFG_VBUSBSEN*/OTG_FS_GCCFG_NOVBUSSENS | OTG_FS_GCCFG_PWRDWN;
